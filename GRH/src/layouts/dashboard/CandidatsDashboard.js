...
import { Person, Work, Favorite, PostAdd, LibraryBooks, AssignmentInd } from "@mui/icons-material";
import { motion } from "framer-motion";

// Option 1: Lazy-loaded imports (ensure default exports in these files)
...
// Option 2: Regular imports for debugging (use this to test if lazy loading is the issue)
...
// Static actions array to prevent recreation
const actions = [
  {
...
const ActionCard = memo(({ action }) => (
  <motion.div
    ...
    whileTap={{ scale: 0.98 }}
    initial={{ opacity: 1, y: 0 }} // Instant display
    animate={{ opacity: 1, y: 0 }}
    transition={{ duration: 0 }} // No animation delay
  >
    <Card
      component={Link}
      to={action.link}
...
const ProfilsList = memo(() => {
  ...
  return (
    // Uncomment Suspense and lazy imports once default exports are confirmed
...
// PropTypes for ProfilsList (optional, as no props are passed)
ProfilsList.propTypes = {};

// Recommendation: Add this to your index.html to preload critical resources
// <link rel="preload" href="/path/to/mui-styles.css" as="style" />
