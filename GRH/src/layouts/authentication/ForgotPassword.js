...
const ForgotPassword = memo(() => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSuccessMessage(data.message || "Un lien de réinitialisation a été envoyé à votre email.");
  ...
  return (
    <IllustrationLayout
      ...
      description="Entrez votre adresse email pour recevoir un lien de réinitialisation de votre mot de passe."
    >
      <ArgonBox
        sx={{
          display: "flex",
...
ForgotPassword.propTypes = {
  // No props are expected, but defining PropTypes for future extensibility
};
